...
/*   Updated: 2024/04/09 15:26:04 by crea             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* get_map_utils */
# define PLAYER_POS "Skeletronk position is somewhere!\n"
# define ENEMY_POS "Enemy NVM, pos is {x} {y}\n"
# define ENEMY_ALIVE "Enemy boh, is alive.\n"
# define ENEMY_INDEX "Enemy index is i don't know\n"
# define ENEMY_NEW_POS "Enemy (42 doesn't want us to know) new position is {x} {y}\n"
# define ERROR_CANT_OPEN_MAP_FILE "Error\nMap file can't be open. Have you checked the name of the map file?\n"

/* check_map_interior */
# define CORRECT_PLAYER_NBR "THE ONE PLAYER START! The one and only... Skeletronk!!!\n"
# define ERROR_PLAYER_NBR "Error\nWrong number of player start: 0\n"
# define CORRECT_EXIT_NBR "THE ONE EXIT! You can escape hell!\n"
# define ERROR_EXIT_NBR "Error\nWrong number of exit: 0. What are you? A pussycat?\n"
# define CORRECT_COLLECT_NBR "Lots COLLECTABLES to pick up! Your D is knocking on heaven's door!\n"
# define ERROR_COLLECT_NBR "Error\nNot enoght bones: 0. What about your boner? It's sad, isn't it?\n"
...
# define ENEMIES_NBR "A lot of ENEMIES in hell right now. Try to avoid, or give them the punta!\n"
...
# define COLLECTABLES_NBR "Remaining bones: a lot! You're boner is getting harder!\n\n"
# define ALL_COLLECT_PICKEDUP "You've earned FULL POWER! Don't waste time! Your boner might disappear!\n\n"
# define MOVES_NBR "You've made a lot of moves! Keep goin Skeletronk!\n"
# define ERROR_EXIT_NOT_OPEN "Error\nDo you have all the bones? Are you sure? That doesn't seems a big boner to me...\n"
# define NEW_PLAYER_POS "Your new position is somewhere! Keep navigate hell!\n"
# define FINAL_PLAYER_POS "You've reached the portal!\n"

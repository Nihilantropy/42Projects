...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/25 16:09:13 by crea              #+#    #+#             */
/*   Updated: 2024/03/25 16:36:51 by crea             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_sprites(t_game *game)
{
	...
	game->tiles.wall = mlx_xpm_file_to_image(mlx_ptr, WALL_SPRITE,
			&width, &height);
	game->tiles.floor = mlx_xpm_file_to_image(mlx_ptr, FLOOR_SPRITE,
			&width, &height);
	game->tiles.player = mlx_xpm_file_to_image(mlx_ptr, PLAYER_SPRITE,
			&width, &height);
	game->tiles.player_inv = mlx_xpm_file_to_image(mlx_ptr, PLAYER_INV_SPRITE,
			&width, &height);
	game->tiles.collect = mlx_xpm_file_to_image(mlx_ptr, COLLECT_SPRITE,
			&width, &height);
	game->tiles.exit = mlx_xpm_file_to_image(mlx_ptr, EXIT_SPRITE,
			&width, &height);
}
